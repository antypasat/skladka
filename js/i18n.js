...
export const STR = {
  pl: {
    ...
    qa_amount_l: 'Kwota',
    rate_l: 'Kurs',
    rate_fetch: 'Kurs z dnia wydatku',
    rate_fetched: 'Kurs EBC z {d}.',
    rate_fail: 'Nie udało się pobrać kursu. Wpisz go ręcznie — np. z aplikacji banku.',
    rate_need: 'Podaj kurs przeliczenia na walutę składki',
    filter_l: 'Pokaż wydatki osoby',
    filter_all: 'Wszyscy',
    pp_paid_total: 'Zapłacił(a)',
    pp_share: 'Udział',
    pp_balance: 'Bilans',
    pp_share_inline: 'udział:',
    pp_none: 'Ta osoba nie ma jeszcze żadnych wydatków.',
    ...
    // footer
    foot_privacy: 'Wszystko liczy się w twojej przeglądarce i nic nie wysyłamy na żaden serwer — link do składki jest jej jedyną kopią poza tym urządzeniem. Jedyny wyjątek: gdy prosisz o kurs waluty, publiczne API EBC dostaje wyłącznie kod waluty i datę.',
  ...
  en: {
    ...
    qa_amount_l: 'Amount',
    rate_l: 'Rate',
    rate_fetch: 'Rate from expense day',
    rate_fetched: 'ECB rate from {d}.',
    rate_fail: 'Could not fetch the rate. Enter it manually — e.g. from your banking app.',
    rate_need: 'Enter the conversion rate to the pot currency',
    filter_l: 'Show one person’s expenses',
    filter_all: 'Everyone',
    pp_paid_total: 'Paid',
    pp_share: 'Share',
    pp_balance: 'Balance',
    pp_share_inline: 'share:',
    pp_none: 'No expenses for this person yet.',
    qa_add: 'Toss it in',
    qa_more: 'Split & date',
    ...
    foot_privacy: 'Everything is computed in your browser and nothing is sent to any server — the share link is the pot’s only copy outside this device. One exception: when you ask for an FX rate, a public ECB API receives only the currency code and the date.',
